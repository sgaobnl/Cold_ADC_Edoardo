...
::python ADC_TEST_CFG.py           CMOS NoSDC OLD_CALI 4
...
python ADC_TEST_CFG.py           BJT NoSDC NEW_CALI 16 
python adc_test_input_full.py    BJT 16
python ADC_TEST_CFG.py           BJT NoSDC NEW_CALI 4 
python adc_test_input_full.py    BJT 4
python ADC_TEST_CFG.py           CMOS NoSDC NEW_CALI 16 
python adc_test_input_full.py    CMOS  16
python ADC_TEST_CFG.py           CMOS NoSDC NEW_CALI 4 
