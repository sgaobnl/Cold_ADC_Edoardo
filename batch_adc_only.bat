...
python ADC_TEST_CFG.py           CMOS NoSDC OLD_CALI 4 SYNC10M 
...
python ADC_TEST_CFG.py           CMOS NoSDC OLD_CALI 16  UNSYNC
python adc_test_input_full.py    CMOS  16
python ADC_TEST_CFG.py           CMOS NoSDC OLD_CALI 4  UNSYNC
