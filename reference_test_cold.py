...
xvrefp_300k_12_6uA=[]
#open 1
with open('E:\Junbin\DUNEADC_TEST\DUNE_COLDADC\monitor\\vrefp_vdd2p62_77k_vref_bjt_9.5pA.csv') as csvfile:
...
#open 2
with open('E:\Junbin\DUNEADC_TEST\DUNE_COLDADC\monitor\\vrefp_vdd2p62_77k_vref_bjt_6.3uA.csv') as csvfile:
    readCSV = csv.reader(csvfile,delimiter=',')
    for row in readCSV:    
...
#open 3
with open('E:\Junbin\DUNEADC_TEST\DUNE_COLDADC\monitor\\vrefp_vdd2p62_77k_vref_bjt_9.5uA.csv') as csvfile:
    readCSV = csv.reader(csvfile,delimiter=',')
    for row in readCSV:    
...
#open 4
with open('E:\Junbin\DUNEADC_TEST\DUNE_COLDADC\monitor\\vrefp_vdd2p62_77k_vref_bjt_12.6uA.csv') as csvfile:
    readCSV = csv.reader(csvfile,delimiter=',')
    for row in readCSV:    
...
ibuff1_300k=[]
#open 5 current
with open('E:\Junbin\DUNEADC_TEST\DUNE_COLDADC\monitor\ibuff1_vdd2p62_77k_vref_bjt_2.csv') as csvfile:
    readCSV = csv.reader(csvfile,delimiter=',')
    for row in readCSV:    
...
fit_ibuff1_300k = np.polyfit(xcode_ibuff1_300k,ibuff1_300k,1)
...
#open 5 current
with open('E:\Junbin\DUNEADC_TEST\DUNE_COLDADC\monitor\ivdac1_vdd2p62_77k_vref_bjt_2.csv') as csvfile:
    readCSV = csv.reader(csvfile,delimiter=',')
    for row in readCSV:    
...
fit_ivdac1_300k = np.polyfit(xcode_ivdac1_300k,ivdac1_300k,1)
...
#plt.title('BJT,77K,Internal reference, VDDA2P5=2.62V,VDDD1P2=2.1V,VDDIO=2.25V')
...
#ax1.legend(('VREFP ioffset=9.5pA','VERFP ioffset=6.3uA','VREFP ioffset=9.5uA','VREFP ioffset=12.6uA'),loc='lower center')
#ax1.grid(True)
#ax1.text(10,1.5,'VBGR=1.182V')
#ax1.text(10,1.3,'VREF_ext = 210mV')
#
#ax2=ax1.twinx()
#ax2.set_ylabel('Current(uA)')
#ax2.plot(xcode_ibuff1_300k,ibuff1_300k,'m*-')
#ax2.plot(xcode_ibuff1_300k,ivdac1_300k,'r*-')
#ax2.legend(('ibuff1 current','ivdac1 current'),loc = 'upper center')
#
#fig.tight_layout()
#plt.show()
...
ax1.grid(True)
ax1.text(0,1.8,'VBGR=1.20V')
ax1.text(0,1.7,'VREF_ext = 233mV')

#fit_300k_9_5pA
ax1.text(0,1.5,'V(9.5pA) = %.4fxcode + (%.4f)'%(fit_300k_9_5pA[0],fit_300k_9_5pA[1]),color='k')
ax1.text(0,1.4,'V(6.3uA) = %.4fxcode + %.4f'%(fit_300k_6_3uA[0],fit_300k_6_3uA[1]),color='g')
ax1.text(0,1.3,'V(9.5uA) = %.4fxcode + %.4f'%(fit_300k_9_5uA[0],fit_300k_9_5uA[1]),color='b')
ax1.text(0,1.2,'V(12.6uA) = %.4fxcode + %.4f'%(fit_300k_12_6uA[0],fit_300k_12_6uA[1]),color='c')

ax1.text(0,1.1,'ibuff1 = %.4fxcode + %.4f'%(fit_ibuff1_300k[0], fit_ibuff1_300k[1]),color='m')
ax1.text(0,1.0,'ivdac1 = %.4fxcode + %.4f'%(fit_ivdac1_300k[0], fit_ivdac1_300k[1]),color='r')

ax2=ax1.twinx()
ax2.set_ylabel('Current(uA)')
ax2.plot(xcode_ibuff1_300k,ibuff1_300k,'m*')
ax2.plot(xcode_ibuff1_300k,ivdac1_300k,'r*')
ax2.plot(xcode_ibuff1_300k,fit_fn_ibuff1_300k(xcode_ibuff1_300k),'m-')
ax2.plot(xcode_ibuff1_300k,fit_fn_ivdac1_300k(xcode_ibuff1_300k),'r-')
